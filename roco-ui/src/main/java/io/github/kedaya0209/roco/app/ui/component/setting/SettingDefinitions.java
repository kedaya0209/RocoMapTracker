    ...
    private static List<SettingCategory> buildCategories() {
        return List.of(
                ...
                cat("UI", "/icon/theme.svg",
                        ...
                        integer("WIKI_ITEM_HEIGHT", "WIKI条目高度", true,
                ...
                cat("交互", "/icon/interactive.svg",
                        ...
                        integer("RESIZE_MARGIN", "窗口拖拽感应区", true,
                ...
                cat("下载", "/icon/download.svg",
                        integer("DOWNLOAD_CONNECT_TIMEOUT", "连接超时(ms)", true,
                ...
                cat("更新", "/icon/update.svg",
                        bool("CHECK_ENABLED", "自动检查更新", true,
                                () -> UpdateConfig.CHECK_ENABLED,
                                v -> UpdateConfig.CHECK_ENABLED = (Boolean) v),
                        integer("CHECK_INTERVAL_HOURS", "检查间隔(小时)", true,
                        ...
                        str("PROXY_URL", "代理链接", false,
                                () -> UpdateConfig.PROXY_URL,
